...
### 新增流控规则
![](image/4.2-JAVA-Sentinel.assets/4.2-JAVA-Sentinel-20251213125540.png)
...
示例：
  - 商品查询接口超过100QPS时限流
  - 用户注册接口超过50QPS时拒绝
![](image/4.2-JAVA-Sentinel.assets/4.2-JAVA-Sentinel-20251213130849.png)
...
场景2：优先级保护  
  ...
  - 确保核心业务不受影响
![](image/4.2-JAVA-Sentinel.assets/4.2-JAVA-Sentinel-20251213130921.png)
**==链路==**
...
![](image/4.2-JAVA-Sentinel.assets/4.2-JAVA-Sentinel-20251213131006.png)
...
## 异常处理图
### 详细
![](image/4.2-JAVA-Sentinel.assets/deepseek_mermaid_20251213_4f2a59.png)

### 省略图
![](image/4.2-JAVA-Sentinel.assets/4.2-JAVA-Sentinel-20251213125127.png)
