...
export const ru: Translation = {
	...
	[Key.siteStatsTotalWords]: "Слов",
	[Key.siteStatsRunningDays]: "Работает",
	[Key.siteStatsDays]: "{days} дней",
	[Key.siteStatsLastUpdate]: "Обновлено",
	...
	// ===== Виджет календаря в боковой панели =====
	[Key.calendar]: "Календарь",
	[Key.calendarJanuary]: "Январь",
	[Key.calendarFebruary]: "Февраль",
	[Key.calendarMarch]: "Март",
	[Key.calendarApril]: "Апрель",
	[Key.calendarMay]: "Май",
	[Key.calendarJune]: "Июнь",
	[Key.calendarJuly]: "Июль",
	[Key.calendarAugust]: "Август",
	[Key.calendarSeptember]: "Сентябрь",
	[Key.calendarOctober]: "Октябрь",
	[Key.calendarNovember]: "Ноябрь",
	[Key.calendarDecember]: "Декабрь",
	...
	[Key.calendarHeatmapWeek]: "{month} мес. · Неделя {week} · {count} ст.",
	...
	[Key.momentsDescription]:
		"Короткие заметки, не ставшие статьями: прочитанная строка, наконец заработавший скрипт, внезапный дождь за окном.",
	[Key.momentsMotto]:
