...
export const ja: Translation = {
	...
	[Key.tocAccordionAuto]: "自動折りたたみ",
	[Key.tocExpandAll]: "すべて展開",
	[Key.tocCollapseAll]: "すべて折りたたむ",
	[Key.tocMindMap]: "マインドマップ",
	[Key.tocMindMapZoomIn]: "拡大",
	[Key.tocMindMapZoomOut]: "縮小",
	[Key.tocMindMapReset]: "ズームをリセット",
	[Key.tocMindMapFullscreen]: "フルスクリーン",
	[Key.music]: "音楽",
	...
	[Key.siteStatsTotalWords]: "文字数",
	[Key.siteStatsRunningDays]: "稼働",
	...
	[Key.profilePersonalSites]: "個人サイト",
	...
	[Key.calendarHeatmapWeek]: "{month}月 · 第{week}週 · {count}記事",
	[Key.contactMe]: "連絡",
	[Key.qqGroup]: "QQグループ",
	[Key.navPosts]: "記事",
	[Key.navMy]: "その他",
